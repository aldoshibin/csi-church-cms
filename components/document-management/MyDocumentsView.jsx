...
import { MyDocumentsFiltersCard } from "@/components/document-management/MyDocumentsFiltersCard";
...
import { ALL_DOCUMENTS_QUICK_ACTIONS, FOLDER_OPTIONS, TYPE_FILTER_OPTIONS, TABLE_CATEGORY_OPTIONS } from "@/lib/mock/vmDocumentManagementMockData";
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-ink-subtle">View and manage documents uploaded by you.</p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_300px]">
        <div className="flex flex-col gap-4">
          ...
          <DocumentsTable
            documents={documents} isLoading={isLoading} showUploadedBy={false}
