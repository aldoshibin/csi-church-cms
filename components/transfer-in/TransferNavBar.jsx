...
export function TransferNavBar({ isFirstStep, onPrevious, onSaveContinue, onSubmit, isSubmitting }) {
  return (
    <div className="flex items-center justify-between rounded-lg border border-border bg-white p-4 shadow-card">
      ...
      <Button type="button" onClick={onSubmit} isLoading={isSubmitting} rightIcon={!isSubmitting && <Check className="h-4 w-4" />}>
