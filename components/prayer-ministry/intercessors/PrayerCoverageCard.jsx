...
export function PrayerCoverageCard({ data }) {
  if (!data) return null;
  return (
    <div className="rounded-lg border border-border bg-white p-4 shadow-card">
      <h3 className="mb-3 text-sm font-semibold text-ink">Prayer Coverage Overview</h3>
      <div className="flex items-center gap-4">
        <div className="relative h-[150px] w-[150px] shrink-0">
          ...
          <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center">
            ...
            <span className="text-center text-[11px] leading-tight text-ink-subtle">{data.totalLabel}</span>
          </div>
        </div>
