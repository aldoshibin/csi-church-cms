...
const ACTIONS = [
  { label: "New Bulletin Request", icon: Plus, href: "/prayer-ministry/bulletin-requests/add" },
  { label: "Manage Templates", icon: FileText, href: "#" },
];

export function BulletinQuickActions() {
  return (
