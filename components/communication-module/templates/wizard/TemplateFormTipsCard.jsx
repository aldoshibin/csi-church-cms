...
const TIPS = [
  ...
  "Personalize using variables for better engagement.",
  "Review your template before saving.",
];

export function TemplateFormTipsCard() {
  return (
    <div className="rounded-lg border border-interactive-100 bg-interactive-50/40 p-5">
      <div className="flex items-center gap-2">
        ...
        <h3 className="text-sm font-semibold text-interactive-700">Tips for Best Results</h3>
      </div>
