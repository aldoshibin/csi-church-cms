  ...
  return (
    <div className="rounded-lg border border-border bg-white p-6 shadow-card">
      ...
      <div className="mt-4">
        ...
        <Row label="Purpose / Category">{form.purposeCategory || undefined}</Row>
        <Row label="Sender ID">{form.senderId}</Row>
      ...
      <div className="mt-4 rounded-lg border border-border bg-surface-canvas/40 p-4">
        <p className="text-xs text-ink-subtle">Message Preview</p>
        <p className="mt-2 whitespace-pre-line text-sm text-ink-muted">{form.message || "No message written yet."}</p>
      </div>
    </div>
  );
}
