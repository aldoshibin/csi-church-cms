...
import { MessageCircle, Send, Truck, MessageSquareReply, Users2 } from "lucide-react";

export function CampaignsStatsRow({ stats }) {
  if (!stats) return null;
  const cards = [
    { key: "totalCampaigns", label: "Total Campaigns", icon: MessageCircle, iconBg: "bg-success-50", iconColor: "text-success-600" },
    { key: "sentCampaigns", label: "Sent Campaigns", icon: Send, iconBg: "bg-interactive-50", iconColor: "text-interactive-600" },
    { key: "deliveryRate", label: "Delivery Rate", icon: Truck, iconBg: "bg-[#F3E8FF]", iconColor: "text-[#7C3AED]" },
    { key: "responseRate", label: "Response Rate", icon: MessageSquareReply, iconBg: "bg-warning-50", iconColor: "text-warning-600" },
    { key: "recipients", label: "Recipients", icon: Users2, iconBg: "bg-warning-50", iconColor: "text-warning-600" },
  ];
  return (
