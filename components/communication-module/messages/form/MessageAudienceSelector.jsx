...
import { AUDIENCE_TYPE_OPTIONS } from "@/lib/mock/vmMessagesMockData";

const TYPE_ICON = { all: Users, groups: UsersRound, ageGroups: PersonStanding, role: BadgeCheck, custom: ListChecks };

export function MessageAudienceSelector({ value, onChange }) {
  return (
    <div className="rounded-lg border border-border bg-white p-6 shadow-card">
      <label className="text-sm font-medium text-ink">
        Audience <span className="text-danger-500">*</span>
      </label>
      <p className="mt-0.5 text-xs text-ink-subtle">Choose who should receive this message.</p>
