...
const REQUIRED_DOCUMENTS = [
  { key: "baptism_certificate", label: "Baptism Certificate", fileType: "PDF" },
  { key: "id_proof", label: "ID Proof", fileType: "PDF/JPG" },
  { key: "address_proof", label: "Address Proof", fileType: "PDF/JPG" },
  { key: "photo", label: "Photo", fileType: "JPG" },
];
  ...
  return (
    <section className="rounded-lg border border-border bg-white p-6 shadow-card">
      ...
      <p className="mt-4 text-xs text-ink-subtle">
        You can upload documents after saving the member. Only the Photo panel above uploads
        immediately (via the real memberService.uploadPhoto endpoint) — the other three document
        types have no upload endpoint yet.
      </p>
    </section>
  );
}
      ...
      <div className="flex gap-2.5">
        ...
        <div>
          ...
          <p className="text-xs leading-relaxed text-ink-muted">
            Fields marked with * are mandatory. You can edit member details anytime after creation.
          </p>
        </div>
      </div>
    </section>
