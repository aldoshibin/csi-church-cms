...
export function LessonRowActionsMenu({ lesson, onView, onEdit, onDuplicate, onPublish, onArchive, onDelete }) {
  return (
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content align="end" sideOffset={6} className="z-50 w-48 rounded-md border border-border bg-white p-1.5 shadow-elevated animate-fade-in">
          <DropdownMenu.Item className={itemClass} onSelect={() => onView?.(lesson)}>
