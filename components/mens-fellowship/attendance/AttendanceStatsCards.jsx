...
import { CalendarDays, Users, UserCheck, CheckCircle2 } from "lucide-react";

export function AttendanceStatsCards({ stats }) {
  const cards = [
    { key: "totalMeetings", label: "Total Meetings", icon: CalendarDays, iconBg: "bg-success-50", iconColor: "text-success-600" },
    { key: "avgAttendance", label: "Avg. Attendance", icon: Users, iconBg: "bg-[#F3E8FF]", iconColor: "text-[#7C3AED]" },
    { key: "totalMembers", label: "Total Members", icon: UserCheck, iconBg: "bg-interactive-50", iconColor: "text-interactive-600" },
    { key: "meetingsHeld", label: "Meetings Held", icon: CheckCircle2, iconBg: "bg-warning-50", iconColor: "text-warning-600" },
  ];
