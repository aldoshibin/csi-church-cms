...
import { Users, Users2, CalendarCheck2, Sparkles } from "lucide-react";

export function FellowshipStatsCards({ stats }) {
  const cards = [
    { key: "totalMembers", label: "Total Members", icon: Users, iconBg: "bg-success-50", iconColor: "text-success-600" },
    { key: "activeGroups", label: "Active Groups", icon: Users2, iconBg: "bg-interactive-50", iconColor: "text-interactive-600" },
    { key: "meetingsThisMonth", label: "Meetings This Month", icon: CalendarCheck2, iconBg: "bg-warning-50", iconColor: "text-warning-600" },
    { key: "upcomingActivities", label: "Upcoming Activities", icon: Sparkles, iconBg: "bg-[#F3E8FF]", iconColor: "text-[#7C3AED]" },
  ];
