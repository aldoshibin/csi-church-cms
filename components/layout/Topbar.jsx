...
export function Topbar({ onOpenMobileSidebar, onToggleSidebar, notificationCount = 3 }) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-border bg-white px-4 sm:px-6">
      ...
      <button
        ...
        className="hidden rounded-md p-2 text-ink-muted hover:bg-surface-muted lg:flex"
      ...
      <div className="relative max-w-md flex-1">
        ...
        <input
          ...
          className="h-11 w-full rounded-md border border-border pl-2 pr-3 text-sm text-ink placeholder:text-ink-subtle focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-interactive-500"
        />
      </div>
