...
export function CenteredDonutCard({ title, total, totalLabel, breakdown }) {
  return (
      ...
      <div className="flex items-center gap-4">
        <div className="relative h-[150px] w-[150px] shrink-0">
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              <Pie data={breakdown} dataKey="count" nameKey="label" innerRadius={48} outerRadius={72} paddingAngle={2}>
          ...
          <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center">
            ...
            <span className="text-center text-[11px] leading-tight text-ink-subtle">{totalLabel}</span>
          </div>
        </div>
