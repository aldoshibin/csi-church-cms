...
import { WT_STATUS_VARIANT } from "@/lib/mock/worshipTeamMembersMockData";
...
export function WtMemberDetailModal({ open, onOpenChange, member, isLoading, onEdit }) {
  return (
    <Modal
      open={open}
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                ...
                <Badge variant={WT_STATUS_VARIANT[member.status] ?? "default"}>{member.status}</Badge>
              </div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  <div className="mt-1"><Badge variant={WT_STATUS_VARIANT[member.status] ?? "default"}>{member.status}</Badge></div>
                </div>
