...
export function SocialLoginButtons({ rememberMe = false }) {
  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <button
        ...
        className="flex h-10 items-center justify-center gap-2 rounded-md border border-auth-line bg-white text-sm font-medium text-auth-text transition-colors hover:bg-auth-soft disabled:opacity-50"
      >
