...
export function MigratedStatCards({ mock }) {
  const cards = [
    { label: "Total Migrated Members", value: mock.cards.totalMigrated, sublabel: "Total migrated out", icon: FaUserClock },
    { label: "This Month", value: mock.cards.thisMonth, sublabel: "Migrated this month", icon: FaUsers },
    { label: "This Year", value: mock.cards.thisYear, sublabel: "Migrated this year", icon: Calendar },
    { label: "Awaiting Confirmation", value: mock.cards.awaitingConfirmation, sublabel: "From receiving church", icon: FaUserCheck },
  ];
