...
import { Calendar, Activity, Users, Clock, RotateCcw } from "lucide-react";
import { formatCurrency } from "@/lib/utils";

export function AuditLogsTopStatsCards({ stats }) {
  const cards = [
    ...
    { key: "recurringDonations", label: "Recurring Donations", icon: Clock, iconBg: "bg-warning-50", iconColor: "text-warning-600" },
    { key: "refundsThisMonth", label: "Refunds (This Month)", icon: RotateCcw, iconBg: "bg-[#CCFBF1]", iconColor: "text-[#0D9488]", isCurrency: true },
  ];
