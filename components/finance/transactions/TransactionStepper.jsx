...
import { STEPS } from "@/hooks/useAddTransactionForm";

export function TransactionStepper({ currentStep, completedSteps, onStepClick }) {
  return (
      ...
      {STEPS.map((step, idx) => {
        ...
        return (
          <React.Fragment key={step.key}>
            ...
            {idx < STEPS.length - 1 && <div className={cn("mx-4 h-px flex-1", step.key < currentStep ? "bg-interactive-500" : "bg-border")} />}
          </React.Fragment>
        );
      })}
    </div>
