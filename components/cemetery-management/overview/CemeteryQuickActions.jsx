...
import { PlusCircle, MapPinPlus, FolderCog, FileBarChart, ChevronRight } from "lucide-react";

const ACTIONS = [
  { label: "Add Burial Record", description: "Record a new burial", href: "/cemetery-management/burial-records/add", icon: PlusCircle },
  { label: "Add New Plot", description: "Create a new cemetery plot", href: "/cemetery-management/plots-management", icon: MapPinPlus },
  { label: "Manage Sections", description: "Add or edit cemetery sections", href: "/cemetery-management/plots-management", icon: FolderCog },
  { label: "Generate Report", description: "View cemetery reports", href: "/cemetery-management/reports", icon: FileBarChart },
];

export function CemeteryQuickActions() {
  return (
