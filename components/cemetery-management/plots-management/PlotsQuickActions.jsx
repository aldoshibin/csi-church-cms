...
import { PlusCircle, FolderCog, MapPin, FileBarChart, ChevronRight } from "lucide-react";
...
const ACTIONS = [
  ...
  { label: "Plot Map View", description: "View cemetery plot map", href: "/cemetery-management/plot-map", icon: MapPin },
  { label: "Generate Report", description: "View plots reports", href: "/cemetery-management/reports", icon: FileBarChart },
];

export function PlotsQuickActions() {
  return (
