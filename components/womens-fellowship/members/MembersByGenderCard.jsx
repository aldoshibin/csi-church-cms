...
export function MembersByGenderCard({ breakdown = [] }) {
  return (
    <div className="rounded-lg border border-border bg-white p-4 shadow-card">
      <div className="mb-3 flex items-center justify-between">
        <h3 className="text-sm font-semibold text-ink">Members by Gender</h3>
...
const ACTIONS = [
  { label: "Add New Member", icon: Plus, href: "/womens-fellowship/members/add", accent: true },
  { label: "Import Members", icon: Upload, href: "/womens-fellowship/members" },
  { label: "Member Directory", icon: Users, href: "/womens-fellowship/members" },
  { label: "View Reports", icon: BarChart3, href: "/womens-fellowship/reports" },
];

export function MembersQuickActions() {
  return (
    <div className="rounded-lg border border-border bg-white p-4 shadow-card">
