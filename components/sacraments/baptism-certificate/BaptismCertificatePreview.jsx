...
export function BaptismCertificatePreview({ name = "Name of the Member" }) {
  return (
    <div className="w-[340px] shrink-0">
      <div className="rounded-lg border border-border bg-white p-4 shadow-card">
        ...
        <div className="relative rounded-md border-4 p-6 text-center" style={{ borderColor: "#0f5443", background: "#fdfaf3" }}>
          ...
          <p className="mb-2 text-sm font-bold uppercase tracking-wide text-ink">Baptism Certificate</p>
          ...
          <p className="text-[11px] leading-relaxed text-ink-subtle">was baptized in the name of</p>
          <p className="text-[11px] leading-relaxed text-ink-subtle">the Father, the Son and the Holy Spirit</p>
          <p className="mt-1 text-[11px] text-ink-subtle">on ________________</p>
          <p className="mt-2 border-t border-dotted border-ink-subtle/40 pt-1 text-[11px] text-ink-subtle">at ________________________________</p>
