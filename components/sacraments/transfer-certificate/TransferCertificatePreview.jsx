...
export function TransferCertificatePreview({ toChurch = "CSI St. Peter's Church,", toCity = "Chennai." }) {
  return (
    <div className="w-[340px] shrink-0">
      <div className="rounded-lg border border-border bg-white p-4 shadow-card">
        ...
        <div className="relative rounded-md border-4 p-6 text-center" style={{ borderColor: "#0f5443", background: "#fdfaf3" }}>
          ...
          <p className="mb-2 text-sm font-bold uppercase tracking-wide text-ink">Transfer Certificate</p>
          ...
          <p className="text-[11px] leading-relaxed text-ink-subtle">
            a member of CSI St. John's Church, Nagercoil,
          </p>
          <p className="text-[11px] leading-relaxed text-ink-subtle">is transferring his/her membership to</p>
          <p className="mt-1 text-[13px] font-bold text-interactive-600">{toChurch}</p>
          <p className="text-[11px] text-ink-subtle">{toCity}</p>
          <p className="mt-2 text-[11px] text-ink-subtle">________ Church.</p>

          <div className="mt-5 flex items-end justify-between px-2">
            <div className="text-left">
              <p className="text-[10px] text-ink-subtle">Date: 25 May 2025</p>
              <div className="mt-3 h-9 w-9 rounded-full border border-dashed border-ink-subtle/40 text-center text-[6px] leading-[34px] text-ink-subtle/50">
                Parish Seal
              </div>
            </div>
