...
export function MarriageStepFooter({ step, onBack, onNext, onConfirm, onCancel }) {
  return (
    <div className="mt-6 flex items-center justify-between border-t border-border pt-5">
      ...
      {step === 5 ? (
        <Button variant="primary" rightIcon={<ChevronRight className="h-4 w-4" />} onClick={onConfirm}>
          Confirm & Save Record
        </Button>
      ) : (
