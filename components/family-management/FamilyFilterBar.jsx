...
const inputCls =
  "h-10 rounded-md border border-border bg-white px-3 text-sm text-ink placeholder:text-ink-subtle focus:border-interactive-500 focus:outline-none focus:ring-2 focus:ring-interactive-500/10";
  ...
  return (
    <div>
      ...
      <div className="relative">
        <select {...props} className={inputCls + " w-full appearance-none pr-8"}>
          {children}
        </select>
...
export function FamilyFilterBar({
  onSearchChange, onStatusChange, onParishChange, onTypeChange,
    ...
    <div className="flex flex-wrap items-end gap-3 rounded-lg border border-border bg-white p-4 shadow-card">
      <div className="min-w-[220px] flex-1">
        ...
        <div className="relative">
          ...
          <input
            type="search"
            placeholder="Search family name, head, phone..."
      ...
      <div className="w-40">
        <SelectField label="Family Status" onChange={(e) => onStatusChange?.(e.target.value)}>
      ...
      <div className="w-48">
        <SelectField label="Parish" onChange={(e) => onParishChange?.(e.target.value)}>
      ...
      <div className="w-40">
        <SelectField label="Family Type" onChange={(e) => onTypeChange?.(e.target.value)}>
          <option value="">All</option>
