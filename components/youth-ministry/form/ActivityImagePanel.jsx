...
export function ActivityImagePanel({ imageName, onUpload }) {
  ...
  return (
    <div className="rounded-lg border border-border bg-white p-4 shadow-card">
      <h3 className="mb-3 text-sm font-semibold text-ink">Activity Image <span className="font-normal text-ink-subtle">(Optional)</span></h3>
