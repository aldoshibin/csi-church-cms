...
export function YmEventImagePanel({ imageName, onUpload }) {
  ...
  return (
    <div className="rounded-lg border border-border bg-white p-4 shadow-card">
      ...
      <label className="flex h-[150px] cursor-pointer flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed border-border text-ink-subtle hover:border-interactive-300 hover:bg-interactive-50">
