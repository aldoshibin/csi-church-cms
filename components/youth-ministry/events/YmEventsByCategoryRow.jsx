...
import { Mail, BookOpen, Cross, HandHeart, Users, LayoutGrid } from "lucide-react";

const ICONS = [Mail, BookOpen, Cross, HandHeart, Users, LayoutGrid];
const COLORS = [
...
export function YmEventsByCategoryRow({ categories = [] }) {
  return (
