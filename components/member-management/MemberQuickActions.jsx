...
const ICON_MAP = {
  "Add New Member": Plus,
  "Add New Family": LuCalendarPlus2,
  "Import Members": FaRegFileLines,
  "Bulk Update Members": IoMdClipboard,
  "Member Directory": FaRegAddressBook,
...
export function MemberQuickActions({ actions = [] }) {
  return (
