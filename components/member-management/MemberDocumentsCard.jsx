...
const DOCS = [
  { key: "member_form", label: "Member Form", ext: "PDF", icon: FileText },
  { key: "profile_photo", label: "Profile Photo", ext: "JPG", icon: ImageIcon },
  { key: "baptism_certificate", label: "Baptism Certificate", ext: "PDF", icon: FileText },
];
...
export function MemberDocumentsCard() {
  return (
    <div className="rounded-lg border border-border bg-white p-5 shadow-card">
      ...
      <p className="mt-2 text-xs text-ink-subtle">You can upload documents after saving the member.</p>
    </div>
  );
}
