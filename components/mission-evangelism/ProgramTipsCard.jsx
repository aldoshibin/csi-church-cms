...
import { PROGRAM_TIPS_MOCK } from "@/lib/mock/vmMissionEvangelismMockData";

export function ProgramTipsCard() {
  return (
    <div className="rounded-lg border border-border bg-white p-5 shadow-card">
      <div className="flex items-center gap-2">
        <Lightbulb className="h-4 w-4 text-interactive-600" />
        <h3 className="text-sm font-semibold text-ink">Program Tips</h3>
      </div>
      <div className="mt-4 flex flex-col gap-4">
        {PROGRAM_TIPS_MOCK.map((tip) => {
