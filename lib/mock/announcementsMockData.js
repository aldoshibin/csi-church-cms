...
const TYPE_BADGE_CLASS = {
  Announcement: "bg-[#ccefe3] text-[#087f70]",
  Event: "bg-[#eaddff] text-[#6f36e8]",
  "Ministry Update": "bg-[#dcedff] text-[#126fc4]",
  Notice: "bg-[#ffead6] text-[#f06b00]",
};
...
const ICON_BG_CLASS = {
  megaphone: "bg-[#dff6ef] text-[#008b7c]",
  calendar: "bg-[#efe5ff] text-[#8b45ff]",
  info: "bg-[#e7f3ff] text-[#087bff]",
  heart: "bg-[#dff6ef] text-[#008b7c]",
  notice: "bg-[#ffefdf] text-[#ff7b22]",
};
