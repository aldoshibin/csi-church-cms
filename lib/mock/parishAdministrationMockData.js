...
export const PARISH_ADMIN_MOCK = {
  ...
  upcomingEvents: [
    { id: 1, day: "20", month: "MAY", title: "Youth Fellowship Meeting", when: "Tuesday, 6:00 PM", location: "Youth Hall", type: "meeting" },
    { id: 2, day: "25", month: "MAY", title: "Sunday School Anniversary", when: "Sunday, 9:30 AM", location: "Main Auditorium", type: "service" },
    { id: 3, day: "01", month: "JUN", title: "Holy Communion Service", when: "Sunday, 8:00 AM", location: "Main Church", type: "service", highlight: true },
    { id: 4, day: "07", month: "JUN", title: "Women's Fellowship Meeting", when: "Saturday, 4:00 PM", location: "Fellowship Hall", type: "event" },
    { id: 5, day: "15", month: "JUN", title: "Parish Council Meeting", when: "Sunday, 5:00 PM", location: "Conference Room", type: "meeting" },
  ],
