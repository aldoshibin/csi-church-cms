...
export const DASHBOARD_MOCK = {
  ...
  //   { id: 5, day: "15", month: "JUN", title: "Parish Council Meeting", when: "Sunday, 5:00 PM", location: "Room" },
  // ],
 upcomingEvents : [
  {
    id: 1,
  ...
  financialOverview: {
    totalIncome: 245780,
    breakdown: [
      { label: "Tithe", amount: 120000, color: "#2f6fea" },
      { label: "Offerings", amount: 65300, color: "#55c66a" },
      { label: "Donations", amount: 45250, color: "#ff9f25" },
