...
const SACRAMENT_BADGE_CLASS = {
  Baptism: "bg-success-50 text-success-600",
  "Holy Communion": "bg-interactive-50 text-interactive-600",
  Confirmation: "bg-purple-50 text-purple-600",
  Marriage: "bg-accent-50 text-accent-600",
  Funeral: "bg-surface-muted text-ink-muted",
};
...
const GENDER_BADGE_CLASS = {
  Male: "bg-interactive-50 text-interactive-600",
  Female: "bg-accent-50 text-accent-600",
};
