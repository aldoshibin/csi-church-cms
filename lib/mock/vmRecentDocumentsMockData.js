export const RECENT_VIEWED_BY_FILTER_OPTIONS = [
  "Thomas Cherian", "Sarah Mathew", "David Christopher", "Anita Rajan", "John Baptiste", "Parish Office",
];

export const RECENT_TYPE_FILTER_OPTIONS = ["PDF", "DOCX", "DOC", "XLSX", "PPTX", "JPG", "TXT"];

export const RECENT_DOCUMENTS_STATS_MOCK = {
  total: 28,
  label: "Total Recent Documents",
  sub: "Viewed in the last 30 days",
};

export const RECENT_DOCUMENTS_STORAGE_MOCK = {
  totalLabel: "10 GB",
  breakdown: [
...
const RECENT_DOCUMENTS_SEED = [
  {
    id: "REC-1001", documentName: "Hall Booking Guidelines.pdf", folder: "Facility Booking", fileType: "PDF", starred: true,
    activityOnLabel: "Viewed On", activityByLabel: "Viewed By",
  ...
  {
    id: "REC-1002", documentName: "Baptism Registration Form.docx", folder: "Sacramental Records", fileType: "DOCX", starred: true,
    activityOnLabel: "Viewed On", activityByLabel: "Viewed By",
  ...
  {
    id: "REC-1003", documentName: "April 2026 - Income Report.xlsx", folder: "Finance & Accounting", fileType: "XLSX", starred: true,
    activityOnLabel: "Viewed On", activityByLabel: "Viewed By",
  ...
  {
    id: "REC-1004", documentName: "Children Sunday School Plan.pptx", folder: "Sunday School", fileType: "PPTX", starred: true,
    activityOnLabel: "Viewed On", activityByLabel: "Viewed By",
  ...
  {
    id: "REC-1005", documentName: "Church Interior.jpg", folder: "Gallery", fileType: "JPG", starred: true,
    activityOnLabel: "Viewed On", activityByLabel: "Viewed By",
  ...
  {
    id: "REC-1006", documentName: "Membership Application.pdf", folder: "Member Management", fileType: "PDF", starred: true,
    activityOnLabel: "Viewed On", activityByLabel: "Viewed By",
  ...
  {
    id: "REC-1007", documentName: "Volunteer Guidelines.doc", folder: "Volunteer Management", fileType: "DOC", starred: true,
    activityOnLabel: "Viewed On", activityByLabel: "Viewed By",
  ...
  {
    id: "REC-1008", documentName: "Event Schedule - May.txt", folder: "Communication Module", fileType: "TXT", starred: true,
    activityOnLabel: "Viewed On", activityByLabel: "Viewed By",
...
export const RECENT_DOCUMENTS_LIST_MOCK = Array.from({ length: 28 }, (_, i) => {
  const base = RECENT_DOCUMENTS_SEED[i % RECENT_DOCUMENTS_SEED.length];
  return { ...base, id: `${base.id}-${i + 1}` };
});

export function buildRecentDocumentDetailMock(id) {
  const base = RECENT_DOCUMENTS_SEED.find((d) => id?.startsWith(d.id)) ?? RECENT_DOCUMENTS_SEED[0];
  return { ...base, id };
}
