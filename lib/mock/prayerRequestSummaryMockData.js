...
const STATUS_BADGE_CLASS = {
  Active: "bg-[#d8f2e6] text-[#02775f]",
  Answered: "bg-[#cfe5ff] text-[#1769c2]",
  Closed: "bg-[#eadbff] text-[#8649d8]",
...
const CATEGORY_BADGE_CLASS = {
  Health: "bg-[#dceee8] text-[#027968]",
  Family: "bg-[#dceee8] text-[#027968]",
  Financial: "bg-[#d8ebff] text-[#187fe7]",
  Employment: "bg-[#efdfff] text-[#8a42ef]",
  Education: "bg-[#ffe8d3] text-[#df6900]",
};
